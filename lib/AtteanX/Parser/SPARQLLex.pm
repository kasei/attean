...
package AtteanX::Parser::SPARQLLex::Iterator 0.035 {
	...
	my $r_ANON					= qr/\[[\t\r\n ]*\]/o;
	my $r_NIL					= qr/\([\n\r\t ]*\)/o;
	my $r_KEYWORDS				= qr/(ABS|ADD|ALL|AS|ASC|ASK|AVG|BASE|BIND|BNODE|BOUND|BY|CEIL|CLEAR|COALESCE|CONCAT|CONSTRUCT|CONTAINS|COPY|COUNT|CREATE|DATA|DATATYPE|DAY|DEFAULT|DELETE|DELETE WHERE|DESC|DESCRIBE|DISTINCT|DISTINCT|DROP|ENCODE_FOR_URI|EXISTS|FILTER|FLOOR|FOLD|FROM|GRAPH|GROUP|GROUP_CONCAT|HASLANG|HASLANGDIR|HAVING|HINT|HOURS|IF|IN|INSERT|INSERT|INTO|IRI|ISBLANK|ISIRI|ISLITERAL|ISNUMERIC|ISTRIPLE|ISURI|LANG|LANGDIR|LANGMATCHES|LCASE|LIMIT|LOAD|MAX|MD5|MIN|MINUS|MINUTES|MONTH|MOVE|NAMED|NOT|NOW|OBJECT|OFFSET|OPTIONAL|ORDER|PREDICATE|PREFIX|RAND|REDUCED|REGEX|REPLACE|ROUND|SAMETERM|SAMPLE|SECONDS|SELECT|SEPARATOR|SERVICE|SHA1|SHA256|SHA384|SHA512|SILENT|STR|STRAFTER|STRBEFORE|STRDT|STRENDS|STRLANGDIR|STRLANG|STRLEN|STRSTARTS|STRUUID|SUBJECT|SUBSTR|SUM|TIMEZONE|TO|TRIPLE|TZ|UCASE|UNDEF|UNFOLD|UNION|URI|USING|UUID|VALUES|WHERE|WITH|YEAR)(?!:)\b/io;
