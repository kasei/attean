...
package Attean::Plan::Quad 0.006 {
	use Moo;
...
package Attean::Plan::NestedLoopJoin 0.006 {
	use Moo;
...
package Attean::Plan::HashJoin 0.006 {
	use Moo;
...
package Attean::Plan::EBVFilter 0.006 {
	use Moo;
...
package Attean::Plan::Merge 0.006 {
	use Moo;
	use Scalar::Util qw(blessed);
...
package Attean::Plan::Union 0.006 {
	use Moo;
	use Scalar::Util qw(blessed);
	with 'Attean::API::Plan', 'Attean::API::BinaryQueryTree';
...
package Attean::Plan::Extend 0.006 {
	use Moo;
	use Scalar::Util qw(blessed);
...
package Attean::Plan::HashDistinct 0.006 {
	use Moo;
	with 'Attean::API::Plan', 'Attean::API::UnaryQueryTree';
...
package Attean::Plan::Unique 0.006 {
	use Moo;
	with 'Attean::API::Plan', 'Attean::API::UnaryQueryTree';
...
package Attean::Plan::Slice 0.006 {
	use Moo;
...
package Attean::Plan::Project 0.006 {
	use Moo;
	with 'Attean::API::Plan', 'Attean::API::UnaryQueryTree';
...
package Attean::Plan::OrderBy 0.006 {
	use Moo;
...
package Attean::Plan::Service 0.006 {
	use Moo;
...
package Attean::Plan::Table 0.006 {
	use Moo;
	use Types::Standard qw(ArrayRef ConsumerOf);
	use namespace::clean;
...
package Attean::Plan::Exists 0.006 {
	use Moo;
	use Types::Standard qw(ArrayRef ConsumerOf);
	use namespace::clean;
	has variables => (is => 'ro', isa => ArrayRef[ConsumerOf['Attean::API::Variable']]);
