...
This document describes Attean::Plan version 0.038
...
package Attean::Plan::Quad 0.038 {
	use Moo;
...
package Attean::Plan::NestedLoopJoin 0.038 {
	use Moo;
...
package Attean::Plan::HashJoin 0.038 {
	use Moo;
	use List::Util qw(all);
	use namespace::clean;
...
package Attean::Plan::EBVFilter 0.038 {
	use Moo;
...
package Attean::Plan::HashDistinct 0.038 {
	use Moo;
	use namespace::clean;
...
package Attean::Plan::Unique 0.038 {
	use Moo;
	use namespace::clean;
...
package Attean::Plan::Load 0.038 {
	use Moo;
	use Encode;
	use LWP::UserAgent;
	use Scalar::Util qw(blessed);
