...
This document describes Attean::API version 0.027
...
package Attean::API::ResultOrTerm 0.027 {
	use Moo::Role;
}

package Attean::API::BlankOrIRI 0.027 {
	use Moo::Role;
}

package Attean::API::TermOrVariable 0.027 {
...
package Attean::Mapper 0.027 {
	use Moo::Role;
	requires 'map'; # my $that = $object->map($this)
}

package Attean::API::Variable 0.027 {
...
package Attean::API::CanonicalizingBindingSet 0.027 {
	use Attean::RDF;
