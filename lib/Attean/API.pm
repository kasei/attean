...
This document describes Attean::API version 0.029
...
package Attean::API::ResultOrTerm 0.029 {
	use Moo::Role;
}

package Attean::API::BlankOrIRI 0.029 {
	use Moo::Role;
}

package Attean::API::TermOrVariable 0.029 {
...
package Attean::Mapper 0.029 {
	use Moo::Role;
	requires 'map'; # my $that = $object->map($this)
}

package Attean::API::Variable 0.029 {
...
package Attean::API::CanonicalizingBindingSet 0.029 {
	use Attean::RDF;
