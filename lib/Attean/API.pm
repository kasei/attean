...
This document describes Attean::API version 0.023
...
package Attean::API::ResultOrTerm 0.023 {
	use Moo::Role;
}

package Attean::API::BlankOrIRI 0.023 {
	use Moo::Role;
}

package Attean::API::TermOrVariable 0.023 {
...
package Attean::Mapper 0.023 {
	use Moo::Role;
	requires 'map'; # my $that = $object->map($this)
}

package Attean::API::Variable 0.023 {
...
package Attean::API::CanonicalizingBindingSet 0.023 {
	use Attean::RDF;
