...
This document describes Attean::API version 0.012
...
package Attean::API::ResultOrTerm 0.012 {
	use Moo::Role;
}

package Attean::API::BlankOrIRI 0.012 {
	use Moo::Role;
}

package Attean::API::TermOrVariable 0.012 {
	use Moo::Role;
...
package Attean::Mapper 0.012 {
	use Moo::Role;
	requires 'map'; # my $that = $object->map($this)
}

package Attean::API::Variable 0.012 {
...
package Attean::API::CanonicalizingBindingSet 0.012 {
	use Moo::Role;
	use Attean::RDF;
	use namespace::clean;
