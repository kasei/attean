...
This document describes Attean::API version 0.004_01
...
package Attean::API::ResultOrTerm 0.004 {
	use Moo::Role;
}

package Attean::API::BlankOrIRI 0.004 {
	use Moo::Role;
}

package Attean::API::TermOrVariable 0.004 {
	use Moo::Role;
	sub equals {
		my ($a, $b)	= @_;
...
package Attean::Mapper 0.004 {
	use Moo::Role;
	requires 'map'; # my $that = $object->map($this)
}

package Attean::API::Variable 0.004 {
	use Moo::Role;
...
package Attean::API::CanonicalizingBindingSet 0.004 {
	use Moo::Role;
	use Attean::RDF;
	use namespace::clean;
	requires 'elements';
