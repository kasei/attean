...
This document describes Attean::QueryPlanner version 0.015
...
The Attean::QueryPlanner class implements a query planner using the
...
package Attean::QueryPlanner 0.015 {
	use Moo;
