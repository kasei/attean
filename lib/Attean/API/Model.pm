...
This document describes Attean::API::Model version 0.038
...
package Attean::API::Model 0.038 {
	use Sub::Install;
...
package Attean::API::MutableModel 0.038 {
	use Attean::RDF;
	use LWP::UserAgent;
...
package Attean::API::ETagCacheableModel 0.038 {
	use Moo::Role;
...
package Attean::API::TimeCacheableModel 0.038 {
	use Moo::Role;
...
package Attean::API::BulkUpdatableModel 0.038 {
	use Moo::Role;
...
package Attean::API::RDFStarModel 0.038 {
	use Moo::Role;
