...
This document describes Attean::API::Model version 0.006
...
package Attean::API::Model 0.006 {
	use Moo::Role;
	use Sub::Install;
...
package Attean::API::MutableModel 0.006 {
	use Moo::Role;
...
package Attean::API::ETagCacheableModel 0.006 {
	use Moo::Role;
...
package Attean::API::TimeCacheableModel 0.006 {
	use Moo::Role;
...
package Attean::API::BulkUpdatableModel 0.006 {
	use Moo::Role;
