...
This document describes Attean::API::Model version 0.005
...
package Attean::API::Model 0.005 {
	use Moo::Role;
	use Sub::Install;
...
package Attean::API::MutableModel 0.005 {
	use Moo::Role;
...
package Attean::API::ETagCacheableModel 0.005 {
	use Moo::Role;
...
package Attean::API::TimeCacheableModel 0.005 {
	use Moo::Role;
...
package Attean::API::BulkUpdatableModel 0.005 {
	use Moo::Role;
