...
package Attean::API::Model 0.016 {
	use Moo::Role;
	use Sub::Install;
...
package Attean::API::MutableModel 0.016 {
	use Moo::Role;
	use Attean::RDF;
	use LWP::UserAgent;
...
package Attean::API::ETagCacheableModel 0.016 {
	use Moo::Role;
...
package Attean::API::TimeCacheableModel 0.016 {
	use Moo::Role;
...
package Attean::API::BulkUpdatableModel 0.016 {
	use Moo::Role;
