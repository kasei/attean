...
This document describes Attean::API::Model version 0.008
...
package Attean::API::Model 0.008 {
	use Moo::Role;
	use Sub::Install;
...
package Attean::API::MutableModel 0.008 {
	use Moo::Role;
...
package Attean::API::ETagCacheableModel 0.008 {
	use Moo::Role;
...
package Attean::API::TimeCacheableModel 0.008 {
	use Moo::Role;
...
package Attean::API::BulkUpdatableModel 0.008 {
	use Moo::Role;
