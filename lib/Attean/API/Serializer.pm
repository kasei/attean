...
This document describes Attean::API::Serializer version 0.013
...
package Attean::API::AbbreviatingSerializer 0.013 {
...
package Attean::API::TripleSerializer 0.013 {
	use Moo::Role;
	with 'Attean::API::Serializer';
	sub handled_type {
...
package Attean::API::QuadSerializer 0.013 {
	use Moo::Role;
	with 'Attean::API::Serializer';
...
package Attean::API::MixedStatementSerializer 0.013 {
	use Moo::Role;
	with 'Attean::API::Serializer';
...
package Attean::API::ResultSerializer 0.013 {
	use Moo::Role;
	with 'Attean::API::Serializer';
	sub handled_type {
