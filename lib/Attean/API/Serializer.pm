...
This document describes Attean::API::Serializer version 0.038
...
package Attean::API::TripleSerializer 0.038 {
	use Moo::Role;
	with 'Attean::API::Serializer';
	sub handled_type {
...
package Attean::API::QuadSerializer 0.038 {
	use Moo::Role;
	with 'Attean::API::Serializer';
...
package Attean::API::MixedStatementSerializer 0.038 {
	use Moo::Role;
	with 'Attean::API::Serializer';
...
package Attean::API::ResultSerializer 0.038 {
	use Moo::Role;
	with 'Attean::API::Serializer';
	sub handled_type {
