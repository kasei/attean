...
This document describes Attean::API::Serializer version 0.005
...
package Attean::API::Serializer 0.005 {
	use Moo::Role;
...
package Attean::API::AbbreviatingSerializer 0.005 {
...
package Attean::API::TripleSerializer 0.005 {
	use Moo::Role;
	with 'Attean::API::Serializer';
	sub handled_type {
...
package Attean::API::QuadSerializer 0.005 {
	use Moo::Role;
	with 'Attean::API::Serializer';
...
package Attean::API::MixedStatementSerializer 0.005 {
	use Moo::Role;
	with 'Attean::API::Serializer';
...
package Attean::API::ResultSerializer 0.005 {
	use Moo::Role;
	with 'Attean::API::Serializer';
	sub handled_type {
