...
Attean::API::TripleSerializer - Role for serializers of L<Attean::API::Triple> objects

=head1 VERSION

This document describes Attean::API::TripleSerializer version 0.001_01

=head1 DESCRIPTION

The Attean::API::TripleSerializer role defines serializers of
