...
This document describes Attean::API::Expression version 0.020
...
package Attean::API::Expression 0.020 {
...
package Attean::API::UnaryExpression 0.020 {
...
package Attean::API::BinaryExpression 0.020 {
	use AtteanX::SPARQL::Constants;
	use AtteanX::SPARQL::Token;
...
package Attean::API::NaryExpression 0.020 {
	use Moo::Role;
...
package Attean::API::AggregateExpression 0.020 {
	use Moo::Role;
	requires 'operator';
