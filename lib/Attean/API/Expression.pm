...
This document describes Attean::API::Expression version 0.008
...
package Attean::API::Expression 0.008 {
	use Moo::Role;
...
package Attean::API::UnaryExpression 0.008 {
	use Moo::Role;
...
package Attean::API::BinaryExpression 0.008 {
	use Moo::Role;
...
package Attean::API::NaryExpression 0.008 {
	use Moo::Role;
...
package Attean::API::AggregateExpression 0.008 {
	use Moo::Role;
	requires 'operator';
