...
package Attean::API::Expression 0.027 {
...
package Attean::API::UnaryExpression 0.027 {
...
package Attean::API::BinaryExpression 0.027 {
	use AtteanX::SPARQL::Constants;
	use AtteanX::SPARQL::Token;
...
package Attean::API::NaryExpression 0.027 {
	use Moo::Role;
...
package Attean::API::AggregateExpression 0.027 {
	use Moo::Role;
	requires 'operator';
