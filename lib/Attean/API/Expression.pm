...
This document describes Attean::API::Expression version 0.007
...
package Attean::API::Expression 0.007 {
	use Moo::Role;
...
package Attean::API::UnaryExpression 0.007 {
	use Moo::Role;
...
package Attean::API::BinaryExpression 0.007 {
	use Moo::Role;
...
package Attean::API::NaryExpression 0.007 {
	use Moo::Role;
...
package Attean::API::AggregateExpression 0.007 {
	use Moo::Role;
	requires 'operator';
