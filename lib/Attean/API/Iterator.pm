...
This document describes Attean::API::Iterator version 0.022
...
package Attean::API::Iterator 0.022 {
...
package Attean::API::RepeatableIterator 0.022 {
	use Moo::Role;
	requires 'reset';
...
package Attean::API::ResultOrTermIterator 0.022 {
	use Moo::Role;
...
package Attean::API::StatementIterator 0.022 {
	use Moo::Role;
	use Scalar::Util qw(blessed);
	requires 'variables';
...
package Attean::API::TripleIterator 0.022 {
	use Moo::Role;
...
package Attean::API::QuadIterator 0.022 {
	use Moo::Role;
	with 'Attean::API::CanonicalizingBindingIterator';
	with 'Attean::API::StatementIterator';
...
package Attean::API::MixedStatementIterator 0.022 {
	use Moo::Role;
	with 'Attean::API::CanonicalizingBindingIterator';
	sub as_quads {
		my $self	= shift;
...
package Attean::API::ResultIterator 0.022 {
...
package Attean::API::TermIterator 0.022 {
	use Moo::Role;
	sub canonicalize {
		my $self	= shift;
		my $mapper	= Attean::TermMap->canonicalization_map;
