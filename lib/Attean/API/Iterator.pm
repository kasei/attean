...
This document describes Attean::API::Iterator version 0.021
...
package Attean::API::Iterator 0.021 {
...
package Attean::API::RepeatableIterator 0.021 {
	use Moo::Role;
	requires 'reset';
...
package Attean::API::ResultOrTermIterator 0.021 {
	use Moo::Role;
...
package Attean::API::ResultIterator 0.021 {
...
package Attean::API::TermIterator 0.021 {
	use Moo::Role;
	sub canonicalize {
		my $self	= shift;
		my $mapper	= Attean::TermMap->canonicalization_map;
