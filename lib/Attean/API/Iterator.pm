...
This document describes Attean::API::Iterator version 0.013
...
package Attean::API::Iterator 0.013 {
	use Moo::Role;
...
package Attean::API::RepeatableIterator 0.013 {
	use Moo::Role;
	requires 'reset';
...
package Attean::API::ResultOrTermIterator 0.013 {
	use Moo::Role;
...
package Attean::API::TripleIterator 0.013 {
	use Moo::Role;
...
package Attean::API::QuadIterator 0.013 {
	use Moo::Role;
	with 'Attean::API::CanonicalizingBindingIterator';
}

package Attean::API::MixedStatementIterator 0.013 {
	use Moo::Role;
	with 'Attean::API::CanonicalizingBindingIterator';
	sub as_quads {
		my $self	= shift;
...
package Attean::API::TermIterator 0.013 {
	use Moo::Role;
	sub canonicalize {
		my $self	= shift;
		my $mapper	= Attean::TermMap->canonicalization_map;
