...
This document describes Attean::API::Iterator version 0.024
...
package Attean::API::RepeatableIterator 0.024 {
	use Moo::Role;
	requires 'reset';
...
package Attean::API::ResultOrTermIterator 0.024 {
	use Moo::Role;
...
package Attean::API::StatementIterator 0.024 {
	use Moo::Role;
	use Scalar::Util qw(blessed);
	requires 'variables';
...
package Attean::API::TripleIterator 0.024 {
	use Moo::Role;
...
package Attean::API::QuadIterator 0.024 {
	use Moo::Role;
	with 'Attean::API::CanonicalizingBindingIterator';
	with 'Attean::API::StatementIterator';
...
package Attean::API::MixedStatementIterator 0.024 {
	use Moo::Role;
	with 'Attean::API::CanonicalizingBindingIterator';
	sub as_quads {
		my $self	= shift;
...
package Attean::API::ResultIterator 0.024 {
...
package Attean::API::TermIterator 0.024 {
	use Moo::Role;
	sub canonicalize {
		my $self	= shift;
		my $mapper	= Attean::TermMap->canonicalization_map;
