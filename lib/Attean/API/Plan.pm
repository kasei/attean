...
This document describes Attean::API::Plan version 0.015
...
package Attean::API::BindingSubstitutionPlan 0.015 {
	use Moo::Role;
...
package Attean::API::UnionScopeVariablesPlan 0.015 {
	use Moo::Role;
	use namespace::clean;
...
package Attean::API::Plan::Join 0.015 {
	use Moo::Role;
