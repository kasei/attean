...
package Attean::API::BindingSubstitutionPlan 0.032 {
	use Moo::Role;
...
package Attean::API::UnionScopeVariablesPlan 0.032 {
	use Moo::Role;
...
package Attean::API::Plan::Join 0.032 {
