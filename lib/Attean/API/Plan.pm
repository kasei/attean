...
This document describes Attean::API::Plan version 0.036
...
package Attean::API::BindingSubstitutionPlan 0.036 {
	use Moo::Role;
...
package Attean::API::UnionScopeVariablesPlan 0.036 {
	use Moo::Role;
...
package Attean::API::Plan::Join 0.036 {
