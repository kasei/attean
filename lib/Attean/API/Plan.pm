...
This document describes Attean::API::Plan version 0.016
...
package Attean::API::BindingSubstitutionPlan 0.016 {
	use Moo::Role;
...
package Attean::API::UnionScopeVariablesPlan 0.016 {
	use Moo::Role;
	use namespace::clean;
...
package Attean::API::Plan::Join 0.016 {
	use Moo::Role;
