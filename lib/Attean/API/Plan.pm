...
This document describes Attean::API::Plan version 0.027
...
package Attean::API::BindingSubstitutionPlan 0.027 {
	use Moo::Role;
...
package Attean::API::UnionScopeVariablesPlan 0.027 {
	use Moo::Role;
...
package Attean::API::Plan::Join 0.027 {
