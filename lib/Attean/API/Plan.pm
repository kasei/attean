...
This document describes Attean::API::Plan version 0.038
...
package Attean::API::BindingSubstitutionPlan 0.038 {
	use Moo::Role;
...
package Attean::API::UnionScopeVariablesPlan 0.038 {
	use Moo::Role;
...
package Attean::API::Plan::Join 0.038 {
