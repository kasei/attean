...
This document describes Attean::API::Plan version 0.006
...
package Attean::API::Planner 0.006 {
	use Moo::Role;
...
package Attean::API::CostPlanner 0.006 {
	use Moo::Role;
	use Types::Standard qw(CodeRef);
	use namespace::clean;
