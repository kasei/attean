...
This document describes Attean::API::Plan version 0.031
...
package Attean::API::BindingSubstitutionPlan 0.031 {
	use Moo::Role;
...
package Attean::API::UnionScopeVariablesPlan 0.031 {
	use Moo::Role;
...
package Attean::API::Plan::Join 0.031 {
