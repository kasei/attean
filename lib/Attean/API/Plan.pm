...
This document describes Attean::API::Plan version 0.008
...
package Attean::API::Planner 0.008 {
	use Moo::Role;
	use Types::Standard qw(CodeRef);
	use namespace::clean;
...
package Attean::API::CostPlanner 0.008 {
	use Moo::Role;
	use Types::Standard qw(CodeRef);
	use namespace::clean;
