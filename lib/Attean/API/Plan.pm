...
This document describes Attean::API::Plan version 0.028
...
package Attean::API::BindingSubstitutionPlan 0.028 {
	use Moo::Role;
...
package Attean::API::UnionScopeVariablesPlan 0.028 {
	use Moo::Role;
...
package Attean::API::Plan::Join 0.028 {
