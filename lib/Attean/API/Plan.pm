...
This document describes Attean::API::Plan version 0.025
...
package Attean::API::BindingSubstitutionPlan 0.025 {
	use Moo::Role;
...
package Attean::API::UnionScopeVariablesPlan 0.025 {
	use Moo::Role;
...
package Attean::API::Plan::Join 0.025 {
