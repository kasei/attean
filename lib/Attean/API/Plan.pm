...
This document describes Attean::API::Plan version 0.026
...
package Attean::API::BindingSubstitutionPlan 0.026 {
	use Moo::Role;
...
package Attean::API::UnionScopeVariablesPlan 0.026 {
	use Moo::Role;
...
package Attean::API::Plan::Join 0.026 {
