...
Attean::API::MixedStatementSerializer - Role for serializers of L<Attean::API::TripleOrQuad> objects

=head1 VERSION

This document describes Attean::API::MixedStatementSerializer version 0.001_01

=head1 DESCRIPTION

The Attean::API::MixedStatementSerializer role defines serializers of
