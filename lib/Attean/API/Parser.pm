...
This document describes Attean::API::Parser version 0.015
...
package Attean::API::Parser 0.015 {
	use Moo::Role;
...
package Attean::API::AbbreviatingParser 0.015 {
	use Moo::Role;
...
package Attean::API::PushParser 0.015 {
	use Moo::Role;
	with 'Attean::API::Parser';
...
package Attean::API::PullParser 0.015 {
	use Moo::Role;
	with 'Attean::API::Parser';
...
package Attean::API::AtOnceParser 0.015 {
	use Moo::Role;
	with 'Attean::API::Parser';
...
package Attean::API::TermParser 0.015 {
...
package Attean::API::TripleParser 0.015 {
...
package Attean::API::QuadParser 0.015 {
...
package Attean::API::MixedStatementParser 0.015 {
...
package Attean::API::ResultOrTermParser 0.015 {
...
package Attean::API::ResultParser 0.015 {
