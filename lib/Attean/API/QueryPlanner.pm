...
This document describes Attean::API::IDPJoinPlanner version 0.028
...
package Attean::API::QueryPlanner 0.028 {
...
package Attean::API::CostPlanner 0.028 {
...
package Attean::API::JoinPlanner 0.028 {
	use Moo::Role;
	requires 'joins_for_plan_alternatives';
}

package Attean::API::NaiveJoinPlanner 0.028 {
...
package Attean::API::SimpleCostPlanner 0.028 {
...
package Attean::API::IDPJoinPlanner 0.028 {
