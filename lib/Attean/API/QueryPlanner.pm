...
This document describes Attean::API::IDPJoinPlanner version 0.014
...
package Attean::API::QueryPlanner 0.014 {
	use Moo::Role;
...
package Attean::API::CostPlanner 0.014 {
	use Moo::Role;
...
package Attean::API::JoinPlanner 0.014 {
	use Moo::Role;
	use namespace::clean;
	requires 'joins_for_plan_alternatives';
}

package Attean::API::NaiveJoinPlanner 0.014 {
	use Moo::Role;
...
package Attean::API::SimpleCostPlanner 0.014 {
	use Moo::Role;
	use namespace::clean;
...
package Attean::API::IDPJoinPlanner 0.014 {
	use Moo::Role;
