...
This document describes Attean::API::IDPJoinPlanner version 0.029
...
package Attean::API::QueryPlanner 0.029 {
...
package Attean::API::CostPlanner 0.029 {
...
package Attean::API::JoinPlanner 0.029 {
	use Moo::Role;
	requires 'joins_for_plan_alternatives';
}

package Attean::API::NaiveJoinPlanner 0.029 {
...
package Attean::API::SimpleCostPlanner 0.029 {
...
package Attean::API::IDPJoinPlanner 0.029 {
