...
package Attean::API::QueryPlanner 0.033 {
...
package Attean::API::CostPlanner 0.033 {
...
package Attean::API::JoinPlanner 0.033 {
	use Moo::Role;
	requires 'joins_for_plan_alternatives';
}

package Attean::API::NaiveJoinPlanner 0.033 {
...
package Attean::API::SimpleCostPlanner 0.033 {
...
package Attean::API::IDPJoinPlanner 0.033 {
