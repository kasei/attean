...
This document describes Attean::Store version 0.009
...
package Attean::API::Store 0.009 {
	use Moo::Role;
}

package Attean::API::TripleStore 0.009 {
	use Moo::Role;
...
package Attean::API::MutableTripleStore 0.009 {
	use Moo::Role;
...
package Attean::API::ETagCacheableTripleStore 0.009 {
	use Moo::Role;
	with 'Attean::API::TripleStore';
...
package Attean::API::TimeCacheableTripleStore 0.009 {
	use Moo::Role;
	with 'Attean::API::TripleStore';
...
package Attean::API::QuadStore 0.009 {
	use Moo::Role;
	with 'Attean::API::Store';
...
package Attean::API::MutableQuadStore 0.009 {
	use Moo::Role;
	use Type::Tiny::Role;
...
package Attean::API::ETagCacheableQuadStore 0.009 {
	use Moo::Role;
	with 'Attean::API::QuadStore';
...
package Attean::API::TimeCacheableQuadStore 0.009 {
	use Moo::Role;
	with 'Attean::API::QuadStore';
