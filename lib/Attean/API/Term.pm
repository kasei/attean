...
This document describes Attean::API::Term version 0.024
...
package Attean::API::Literal 0.024 {
	use IRI;
...
package Attean::API::DateTimeLiteral 0.024 {
...
package Attean::API::CanonicalizingLiteral 0.024 {
	use Moo::Role;
	requires 'canonicalized_term';
}

package Attean::API::NumericLiteral 0.024 {
...
package Attean::API::Blank 0.024 {
	use Scalar::Util qw(blessed);
	use AtteanX::SPARQL::Constants;
	use AtteanX::SPARQL::Token;
	use Attean::API::Query;
