...
This document describes Attean::API::Term version 0.028
...
package Attean::API::Literal 0.028 {
	use IRI;
...
package Attean::API::DateTimeLiteral 0.028 {
...
package Attean::API::CanonicalizingLiteral 0.028 {
	use Moo::Role;
	requires 'canonicalized_term';
}

package Attean::API::BooleanLiteral 0.028 {
...
package Attean::API::NumericLiteral 0.028 {
	use Scalar::Util qw(blessed looks_like_number);
...
package Attean::API::Blank 0.028 {
	use Scalar::Util qw(blessed);
	use AtteanX::SPARQL::Constants;
	use AtteanX::SPARQL::Token;
	use Attean::API::Query;
