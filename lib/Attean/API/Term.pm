...
This document describes Attean::API::Term version 0.020
...
package Attean::API::Literal 0.020 {
	use IRI;
...
package Attean::API::DateTimeLiteral 0.020 {
...
package Attean::API::CanonicalizingLiteral 0.020 {
	use Moo::Role;
	requires 'canonicalized_term';
}

package Attean::API::NumericLiteral 0.020 {
...
package Attean::API::Blank 0.020 {
	use Scalar::Util qw(blessed);
	use AtteanX::SPARQL::Constants;
	use AtteanX::SPARQL::Token;
	use Attean::API::Query;
