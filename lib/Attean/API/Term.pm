...
This document describes Attean::API::Term version 0.007
...
package Attean::API::Literal 0.007 {
	use Moo::Role;
	use IRI;
...
package Attean::API::DateTimeLiteral 0.007 {
	use Moo::Role;
...
package Attean::API::CanonicalizingLiteral 0.007 {
	use Moo::Role;
	requires 'canonicalized_term';
}

package Attean::API::NumericLiteral 0.007 {
	use Moo::Role;
...
package Attean::API::Blank 0.007 {
	use Moo::Role;
	use Scalar::Util qw(blessed);
	use namespace::clean;
