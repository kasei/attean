...
This document describes Attean::API::Term version 0.013
...
package Attean::API::Literal 0.013 {
	use Moo::Role;
	use IRI;
...
package Attean::API::DateTimeLiteral 0.013 {
	use Moo::Role;
...
package Attean::API::CanonicalizingLiteral 0.013 {
	use Moo::Role;
	requires 'canonicalized_term';
}

package Attean::API::NumericLiteral 0.013 {
	use Moo::Role;
...
package Attean::API::Blank 0.013 {
	use Moo::Role;
	use Scalar::Util qw(blessed);
	use AtteanX::SPARQL::Constants;
	use AtteanX::SPARQL::Token;
