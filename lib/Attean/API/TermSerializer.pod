...
Attean::API::TermSerializer - Role for serializers of L<Attean::API::Term> objects

=head1 VERSION

This document describes Attean::API::TermSerializer version 0.001_01

=head1 DESCRIPTION

The Attean::API::TermSerializer role defines serializers of
