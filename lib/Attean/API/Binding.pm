...
This document describes Attean::API::Binding version 0.016
...
package Attean::API::Binding 0.016 {
	use Moo::Role;
...
package Attean::API::TripleOrQuadPattern 0.016 {
...
package Attean::API::TripleOrQuad 0.016 {
	use Moo::Role;
...
package Attean::API::TriplePattern 0.016 {
	use Moo::Role;
	use List::MoreUtils qw(zip);
	use Scalar::Util qw(blessed);
	use namespace::clean;
...
package Attean::API::Triple 0.016 {
	use Moo::Role;
...
package Attean::API::QuadPattern 0.016 {
	use Scalar::Util qw(blessed);
	use List::MoreUtils qw(zip);
	use Moo::Role;
	use namespace::clean;
...
package Attean::API::Result 0.016 {
	use Moo::Role;
