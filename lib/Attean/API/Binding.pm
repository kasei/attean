...
This document describes Attean::API::Binding version 0.036
...
package Attean::API::Binding 0.036 {
...
package Attean::API::TripleOrQuadPattern 0.036 {
...
package Attean::API::TripleOrQuad 0.036 {
...
package Attean::API::TriplePattern 0.036 {
	use List::Util qw(mesh);
	use Scalar::Util qw(blessed);
...
package Attean::API::Triple 0.036 {
	use Scalar::Util qw(blessed);
	use Moo::Role;
...
package Attean::API::QuadPattern 0.036 {
	use Scalar::Util qw(blessed);
	use List::Util qw(mesh);
...
package Attean::API::Result 0.036 {
