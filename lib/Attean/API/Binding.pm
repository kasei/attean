...
This document describes Attean::API::Binding version 0.032
...
package Attean::API::Binding 0.032 {
...
package Attean::API::TripleOrQuadPattern 0.032 {
...
package Attean::API::TripleOrQuad 0.032 {
...
package Attean::API::TriplePattern 0.032 {
	use List::MoreUtils qw(zip);
	use Scalar::Util qw(blessed);
...
package Attean::API::Triple 0.032 {
	use Scalar::Util qw(blessed);
	use Moo::Role;
...
package Attean::API::QuadPattern 0.032 {
	use Scalar::Util qw(blessed);
	use List::MoreUtils qw(zip);
...
package Attean::API::Result 0.032 {
