...
This document describes Attean::API::Binding version 0.020
...
package Attean::API::Binding 0.020 {
...
package Attean::API::TripleOrQuadPattern 0.020 {
...
package Attean::API::TripleOrQuad 0.020 {
...
package Attean::API::TriplePattern 0.020 {
	use Moo::Role;
	use List::MoreUtils qw(zip);
	use Scalar::Util qw(blessed);
...
package Attean::API::Triple 0.020 {
	use Moo::Role;
...
package Attean::API::QuadPattern 0.020 {
	use Scalar::Util qw(blessed);
	use List::MoreUtils qw(zip);
...
package Attean::API::Result 0.020 {
