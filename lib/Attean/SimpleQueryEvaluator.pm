...
This document describes Attean::SimpleQueryEvaluator version 0.037
...
package Attean::SimpleQueryEvaluator 0.037 {
	use Moo;
...
package Attean::SimpleQueryEvaluator::ExpressionEvaluator 0.037 {
	use Moo;
	use Attean::RDF;
	use Scalar::Util qw(blessed);
