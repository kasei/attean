...
This document describes Attean::SimpleQueryEvaluator version 0.016
...
package Attean::SimpleQueryEvaluator 0.016 {
	use Moo;
...
package Attean::SimpleQueryEvaluator::ExpressionEvaluator 0.016 {
	use Moo;
	use Attean::RDF;
	use Scalar::Util qw(blessed);
