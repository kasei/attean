...
This document describes Attean::SimpleQueryEvaluator version 0.008
...
package Attean::SimpleQueryEvaluator 0.008 {
	use Moo;
...
package Attean::SimpleQueryEvaluator::ExpressionEvaluator 0.008 {
	use Moo;
	use Attean::RDF;
	use Scalar::Util qw(blessed);
