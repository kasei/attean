...
This document describes Attean::SimpleQueryEvaluator version 0.025
...
package Attean::SimpleQueryEvaluator 0.025 {
	use Moo;
...
package Attean::SimpleQueryEvaluator::ExpressionEvaluator 0.025 {
	use Moo;
	use Attean::RDF;
	use Scalar::Util qw(blessed);
