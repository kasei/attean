...
This document describes Attean::SimpleQueryEvaluator version 0.012
...
package Attean::SimpleQueryEvaluator 0.012 {
	use Moo;
...
package Attean::SimpleQueryEvaluator::ExpressionEvaluator 0.012 {
	use Moo;
	use Attean::RDF;
	use Scalar::Util qw(blessed);
