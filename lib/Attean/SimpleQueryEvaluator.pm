...
This document describes Attean::SimpleQueryEvaluator version 0.006
...
package Attean::SimpleQueryEvaluator 0.006 {
	use Moo;
...
package Attean::SimpleQueryEvaluator::ExpressionEvaluator 0.006 {
	use Moo;
	use Attean::RDF;
	use Scalar::Util qw(blessed);
