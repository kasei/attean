...
This document describes Attean::SimpleQueryEvaluator version 0.026
...
package Attean::SimpleQueryEvaluator 0.026 {
	use Moo;
...
package Attean::SimpleQueryEvaluator::ExpressionEvaluator 0.026 {
	use Moo;
	use Attean::RDF;
	use Scalar::Util qw(blessed);
