...
This document describes Attean::SimpleQueryEvaluator version 0.005
...
package Attean::SimpleQueryEvaluator 0.005 {
	use Moo;
...
package Attean::SimpleQueryEvaluator::ExpressionEvaluator 0.005 {
	use Moo;
	use Attean::RDF;
	use Scalar::Util qw(blessed);
