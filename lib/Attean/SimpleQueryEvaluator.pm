...
This document describes Attean::SimpleQueryEvaluator version 0.004_01
...
package Attean::SimpleQueryEvaluator 0.004 {
	use Moo;
...
package Attean::SimpleQueryEvaluator::ExpressionEvaluator 0.004 {
	use Moo;
	use Attean::RDF;
	use Scalar::Util qw(blessed);
