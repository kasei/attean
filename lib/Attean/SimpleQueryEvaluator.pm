...
This document describes Attean::SimpleQueryEvaluator version 0.015
...
package Attean::SimpleQueryEvaluator 0.015 {
	use Moo;
...
package Attean::SimpleQueryEvaluator::ExpressionEvaluator 0.015 {
	use Moo;
	use Attean::RDF;
	use Scalar::Util qw(blessed);
