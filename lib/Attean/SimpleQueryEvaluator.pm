...
This document describes Attean::SimpleQueryEvaluator version 0.009
...
package Attean::SimpleQueryEvaluator 0.009 {
	use Moo;
...
package Attean::SimpleQueryEvaluator::ExpressionEvaluator 0.009 {
	use Moo;
	use Attean::RDF;
	use Scalar::Util qw(blessed);
