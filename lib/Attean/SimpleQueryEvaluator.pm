...
This document describes Attean::SimpleQueryEvaluator version 0.007
...
package Attean::SimpleQueryEvaluator 0.007 {
	use Moo;
...
package Attean::SimpleQueryEvaluator::ExpressionEvaluator 0.007 {
	use Moo;
	use Attean::RDF;
	use Scalar::Util qw(blessed);
