...
This document describes Attean::SimpleQueryEvaluator version 0.014
...
package Attean::SimpleQueryEvaluator 0.014 {
	use Moo;
...
package Attean::SimpleQueryEvaluator::ExpressionEvaluator 0.014 {
	use Moo;
	use Attean::RDF;
	use Scalar::Util qw(blessed);
