...
This document describes Attean::SimpleQueryEvaluator version 0.036
...
package Attean::SimpleQueryEvaluator 0.036 {
	use Moo;
...
package Attean::SimpleQueryEvaluator::ExpressionEvaluator 0.036 {
	use Moo;
	use Attean::RDF;
	use Scalar::Util qw(blessed);
