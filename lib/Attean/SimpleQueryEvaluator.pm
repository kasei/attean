...
This document describes Attean::SimpleQueryEvaluator version 0.013
...
package Attean::SimpleQueryEvaluator 0.013 {
	use Moo;
...
package Attean::SimpleQueryEvaluator::ExpressionEvaluator 0.013 {
	use Moo;
	use Attean::RDF;
	use Scalar::Util qw(blessed);
