...
This document describes Attean::TripleModel version 0.036
...
package Attean::TripleModel 0.036 {
	use Moo;
...
package Attean::AddativeTripleModelRole 0.036 {
...
package Attean::MutableTripleModel 0.036 {
	use Moo;
	use Types::Standard qw(ArrayRef ConsumerOf HashRef);
...
package Attean::AddativeTripleModel 0.036 {
	use Moo;
	use Scalar::Util qw(blessed);
	use Types::Standard qw(CodeRef);
	use namespace::clean;
...
package Attean::AddativeMutableTripleModel 0.036 {
	use Moo;
	use Scalar::Util qw(blessed);
	use Types::Standard qw(CodeRef);
	use namespace::clean;
