...
This document describes Attean::TripleModel version 0.014
...
package Attean::TripleModel 0.014 {
	use Moo;
...
package Attean::AddativeTripleModelRole 0.014 {
	use Moo::Role;
...
package Attean::MutableTripleModel 0.014 {
	use Moo;
	use Types::Standard qw(ArrayRef ConsumerOf HashRef);
...
package Attean::AddativeTripleModel 0.014 {
	use Moo;
	use Scalar::Util qw(blessed);
	use Types::Standard qw(CodeRef);
	use namespace::clean;
...
package Attean::AddativeMutableTripleModel 0.014 {
	use Moo;
	use Scalar::Util qw(blessed);
	use Types::Standard qw(CodeRef);
	use namespace::clean;
