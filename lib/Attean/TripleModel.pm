...
This document describes Attean::TripleModel version 0.026
...
package Attean::TripleModel 0.026 {
	use Moo;
...
package Attean::AddativeTripleModelRole 0.026 {
...
package Attean::MutableTripleModel 0.026 {
	use Moo;
	use Types::Standard qw(ArrayRef ConsumerOf HashRef);
...
package Attean::AddativeTripleModel 0.026 {
	use Moo;
	use Scalar::Util qw(blessed);
	use Types::Standard qw(CodeRef);
	use namespace::clean;
...
package Attean::AddativeMutableTripleModel 0.026 {
	use Moo;
	use Scalar::Util qw(blessed);
	use Types::Standard qw(CodeRef);
	use namespace::clean;
