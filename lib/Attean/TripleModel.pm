...
This document describes Attean::TripleModel version 0.037
...
package Attean::TripleModel 0.037 {
	use Moo;
...
package Attean::AddativeTripleModelRole 0.037 {
...
package Attean::MutableTripleModel 0.037 {
	use Moo;
	use Types::Standard qw(ArrayRef ConsumerOf HashRef);
...
package Attean::AddativeTripleModel 0.037 {
	use Moo;
	use Scalar::Util qw(blessed);
	use Types::Standard qw(CodeRef);
	use namespace::clean;
...
package Attean::AddativeMutableTripleModel 0.037 {
	use Moo;
	use Scalar::Util qw(blessed);
	use Types::Standard qw(CodeRef);
	use namespace::clean;
