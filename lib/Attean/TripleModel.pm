...
This document describes Attean::TripleModel version 0.027
...
package Attean::TripleModel 0.027 {
	use Moo;
...
package Attean::AddativeTripleModelRole 0.027 {
...
package Attean::MutableTripleModel 0.027 {
	use Moo;
	use Types::Standard qw(ArrayRef ConsumerOf HashRef);
...
package Attean::AddativeTripleModel 0.027 {
	use Moo;
	use Scalar::Util qw(blessed);
	use Types::Standard qw(CodeRef);
	use namespace::clean;
...
package Attean::AddativeMutableTripleModel 0.027 {
	use Moo;
	use Scalar::Util qw(blessed);
	use Types::Standard qw(CodeRef);
	use namespace::clean;
