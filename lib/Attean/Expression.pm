...
This document describes Attean::Expression version 0.007
...
package Attean::ValueExpression 0.007 {
	use Moo;
...
package Attean::UnaryExpression 0.007 {
	use Moo;
...
package Attean::BinaryExpression 0.007 {
	use Moo;
	use Types::Standard qw(Enum);
	use namespace::clean;
...
package Attean::FunctionExpression 0.007 {
	use Moo;
...
package Attean::AggregateExpression 0.007 {
	use Moo;
...
package Attean::CastExpression 0.007 {
	use Moo;
...
package Attean::ExistsExpression 0.007 {
	use Moo;
	use Types::Standard qw(ConsumerOf);
	use namespace::clean;
