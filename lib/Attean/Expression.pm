...
This document describes Attean::Expression version 0.038
...
package Attean::ValueExpression 0.038 {
	use Moo;
...
package Attean::UnaryExpression 0.038 {
	use Moo;
...
package Attean::BinaryExpression 0.038 {
	use Moo;
	use Types::Standard qw(Enum);
	use namespace::clean;
...
package Attean::FunctionExpression 0.038 {
	use Moo;
...
package Attean::ExistsExpression 0.038 {
	use Moo;
	use AtteanX::SPARQL::Constants;
	use AtteanX::SPARQL::Token;
	use Types::Standard qw(ConsumerOf);
...
package Attean::ExistsPlanExpression 0.038 {
	use Moo;
	use Types::Standard qw(ConsumerOf);
	use namespace::clean;
