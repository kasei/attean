...
{
	my $ser	= Attean->get_serializer('SPARQLTSV')->new();
	does_ok($ser, 'Attean::API::Serializer');
	does_ok($ser, 'Attean::API::ResultSerializer');
	isa_ok($ser, 'AtteanX::Serializer::SPARQLTSV');
...
<http://example.org/p>	_:x	"1"^^<http://www.w3.org/2001/XMLSchema#integer>
<http://example.org/p>	_:x	"2"@en-US
	<http://perlrdf.org/>	
END
